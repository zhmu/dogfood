...
constexpr Syscall syscalls[] = {
    ...
    { "read", SYS_read, { { "fd", ArgumentType::FD, Direction::In }, { "buf", ArgumentType::Void, Direction::In }, { "size", ArgumentType::Size, Direction::In } } },
    { "write ", SYS_write, { { "fd", ArgumentType::FD, Direction::In }, { "buf", ArgumentType::Void, Direction::Out }, { "size", ArgumentType::Size, Direction::In } } },
    { "open ", SYS_open, { { "path", ArgumentType::PathString, Direction::In }, { "flags", ArgumentType::Int, Direction::In }, { "mode", ArgumentType::Int, Direction::In } } },
    { "close", SYS_close, { { "fd", ArgumentType::FD, Direction::In } } },
    { "unlink ", SYS_unlink, { { "path", ArgumentType::PathString, Direction::In } } },
    { "seek", SYS_seek, { { "fd", ArgumentType::FD, Direction::In }, { "offset", ArgumentType::OffsetPtr, Direction::InOut }, { "whence", ArgumentType::Int, Direction::In } } },
    { "clone", SYS_clone, { { "flags", ArgumentType::Int, Direction::In } } },
    { "waitpid", SYS_waitpid, { { "pid", ArgumentType::PID, Direction::In }, { "stat_loc", ArgumentType::IntPtr, Direction::Out }, { "options", ArgumentType::Int, Direction::In } } },
    { "execve", SYS_execve, { { "path", ArgumentType::PathString, Direction::In }, { "argv", ArgumentType::CharPtrArray, Direction::In }, { "envp", ArgumentType::CharPtrArray, Direction::In } } },
    { "vmop", SYS_vmop, { { "opts", ArgumentType::Void, Direction::In } } },
    { "dup", SYS_dup, { { "fd", ArgumentType::FD, Direction::In } } },
    { "rename", SYS_rename, { { "oldpath", ArgumentType::PathString, Direction::In }, { "newpath", ArgumentType::PathString, Direction::In } } },
    { "stat", SYS_stat, { { "path", ArgumentType::PathString, Direction::In }, { "buf", ArgumentType::Void, Direction::Out } } },
    { "chdir", SYS_chdir, { { "path", ArgumentType::PathString, Direction::In } } },
    { "fstat", SYS_fstat, { { "fd", ArgumentType::FD, Direction::In }, { "buf", ArgumentType::Void, Direction::Out } } },
    { "fchdir", SYS_fchdir, { { "fd", ArgumentType::FD, Direction::In } } },
    { "fcntl", SYS_fcntl, { { "fd", ArgumentType::FD, Direction::In }, { "cmd", ArgumentType::Int, Direction::In } } },
    { "link", SYS_link, { { "oldpath", ArgumentType::PathString, Direction::In }, { "newpath", ArgumentType::PathString, Direction::In } } },
    { "utime", SYS_utime, { { "path", ArgumentType::PathString, Direction::In }, { "times", ArgumentType::Void, Direction::In } } },
    { "clock_settime", SYS_clock_settime, { { "id", ArgumentType::Int, Direction::In }, { "tp", ArgumentType::Void, Direction::In } } },
    { "clock_gettime", SYS_clock_gettime, { { "id", ArgumentType::Int, Direction::In }, { "tp", ArgumentType::Void, Direction::Out } } },
    { "clock_getres", SYS_clock_getres, { { "id", ArgumentType::Int, Direction::In }, { "res", ArgumentType::Void, Direction::Out } } },
    { "readlink", SYS_readlink, { { "path", ArgumentType::PathString, Direction::In }, { "buffer", ArgumentType::Void, Direction::Out }, { "bufsize", ArgumentType::Size, Direction::In } } },
    { "lstat", SYS_lstat, { { "path", ArgumentType::PathString, Direction::In }, { "buf", ArgumentType::Void, Direction::Out } } },
    { "getcwd", SYS_getcwd, { { "path", ArgumentType::Void, Direction::Out }, { "bufsize", ArgumentType::Size, Direction::In } } },
    { "sigaction", SYS_sigaction },
    { "sigprocmask", SYS_sigprocmask },
    { "sigsuspend", SYS_sigsuspend },
    { "kill", SYS_kill, { { "pid", ArgumentType::PID, Direction::In }, { "sig", ArgumentType::Int, Direction::In } } },
    { "sigreturn", SYS_sigreturn },
    { "ioctl", SYS_ioctl, { { "fd", ArgumentType::FD, Direction::In }, { "op", ArgumentType::Int, Direction::In } } },
    { "setpgrp", SYS_getpgrp },
    { "setpgid", SYS_setpgid, { { "pid", ArgumentType::PID, Direction::In }, { "pgid", ArgumentType::PID, Direction::In } } },
    { "setsid", SYS_setsid },
    { "dup2", SYS_dup2, { { "fd", ArgumentType::FD, Direction::In }, { "newindex", ArgumentType::FD, Direction::In } } },
    { "mount", SYS_mount, { { "type", ArgumentType::CharPtr, Direction::In }, { "source", ArgumentType::PathString, Direction::In }, { "dir", ArgumentType::PathString, Direction::In }, { "flags", ArgumentType::Int, Direction::In } } },
    { "unmount", SYS_unmount, { { "dir", ArgumentType::PathString, Direction::In }, { "flags", ArgumentType::Int, Direction::In } } },
    { "statfs", SYS_statfs, { { "path", ArgumentType::PathString, Direction::In }, { "buf", ArgumentType::Void, Direction::Out } } },
    { "fstatfs", SYS_fstatfs, { { "fd", ArgumentType::FD, Direction::In }, { "buf", ArgumentType::Void, Direction::Out } } },
    { "nanosleep", SYS_nanosleep, { { "rqtp", ArgumentType::Void, Direction::In }, { "rmtp", ArgumentType::Void, Direction::Out } } },
    ...
    { "getpid", SYS_getpid },
    { "getppid", SYS_getppid },
    { "symlink", SYS_symlink, { { "oldpath", ArgumentType::PathString, Direction::In }, { "newpath", ArgumentType::PathString, Direction::In } } },
...
const Syscall* GetSyscallByNumber(int no)
{
    for (const Syscall& syscall: syscalls) {
        if (syscall.num == no) return &syscall;
    }
    return nullptr;
}
...
void PrintArguments(amd64::TrapFrame* tf, bool in, const SyscallArgument args[])
{
    auto getArgument = [tf](int n) {
        switch(n) {
            case 1: return syscall::GetArgument<1>(*tf);
            case 2: return syscall::GetArgument<2>(*tf);
            case 3: return syscall::GetArgument<3>(*tf);
            case 4: return syscall::GetArgument<4>(*tf);
            case 5: return syscall::GetArgument<5>(*tf);
            default: return static_cast<unsigned long>(0);
        }
    };
    ...
    for(const auto* arg = &args[0]; arg->name != nullptr; ++arg, ++n) {
        if(in) {
            if (arg->dir == Direction::Out) continue;
        } else {
            if (arg->dir == Direction::In) continue;
        }
        if (m++ > 0) printf(", ");
        switch(arg->type) {
