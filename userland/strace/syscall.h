...
namespace syscall {
    ...
    using SyscallArguments = std::array<SyscallArgument, 7>;

    struct Syscall {
        int num;
        const char* name;
        ReturnType retType;
        const SyscallArguments args;
    };
    ...
    constexpr Syscall syscalls[] = {
        ...
        },
        {
            ...
            {{
                {"fd", ArgumentType::FD, Direction::In},
                {"op", ArgumentType::Long, Direction::In},
                {"arg1", ArgumentType::Long, Direction::In},
                {"arg2", ArgumentType::Long, Direction::In},
                {"arg3", ArgumentType::Long, Direction::In},
                {"arg4", ArgumentType::Long, Direction::In}
            }}
        },
        {
        ...
        {
            SYS_setreuid, "setreuid", ReturnType::IntOrErrNo,
            {{
                {"ruid", ArgumentType::Int, Direction::In},
                {"euid", ArgumentType::Int, Direction::In},
            }}
        },
        {
            SYS_setregid, "setregid", ReturnType::IntOrErrNo,
            {{
                {"rgid", ArgumentType::Int, Direction::In},
                {"egid", ArgumentType::Int, Direction::In},
            }}
        },
        {
            SYS_sigpending, "sigpending", ReturnType::IntOrErrNo,
            {{
                {"set", ArgumentType::Void, Direction::Out},
            }}
        },
        {
            SYS_sigwait, "sigwait", ReturnType::IntOrErrNo,
            {{
                {"set", ArgumentType::Void, Direction::In},
                {"sig", ArgumentType::IntPtr, Direction::Out},
            }}
        },
        {
            SYS_pipe, "pipe", ReturnType::IntOrErrNo,
            {{
                {"fds", ArgumentType::IntPtr, Direction::Out},
            }}
        },
        {
            SYS_select, "select", ReturnType::IntOrErrNo,
            {{
                {"nfds", ArgumentType::Int, Direction::In},
                {"readfds", ArgumentType::FdSetPtr, Direction::InOut},
                {"writefds", ArgumentType::FdSetPtr, Direction::InOut},
                {"exceptfds", ArgumentType::FdSetPtr, Direction::InOut},
                {"timeout", ArgumentType::Timeval, Direction::In},
            }}
        },
    };
    // clang-format on
