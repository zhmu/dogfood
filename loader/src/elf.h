...
#define DT_PLTRELSZ                                                                            \
    2 /* Total size, in bytes, of the relocation entries associated with the procedure linkage \
         table */
...
#define DT_PLTREL \
    20 /* Type of relocation entries used for procedure linkage table (DT_REL / DT_RELA) */
#define DT_DEBUG 21 /* Reserved for debugger use */
#define DT_TEXTREL                                                                          \
    22 /* Presence signals that the relocation table contains relocation for a non-writable \
          segment */
#define DT_JMPREL 23 /* Address of the relocations associated with the procedure linkage table */
#define DT_BIND_NOW                                                                              \
    24 /* Presence signals that all relocations must be processed before transferring control to \
          program */
